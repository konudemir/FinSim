...
namespace FinSim.Infrastructure.Migrations
{
    ...
    [Migration("20260827141606_AddPortfolioItemUserInstrumentIndex")]
    partial class AddPortfolioItemUserInstrumentIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinSim.Domain.Models.FavoriteInstrument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FinSim.Domain.Models.Instrument", b =>
                {
                    ...
                    b.Property<decimal?>("LastRealPrice")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<DateTimeOffset?>("LastRealPriceAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("FinSim.Domain.Models.Transaction", b =>
                {
                    ...
                    b.Property<decimal?>("BuyerRealizedPnL")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal?>("SellerRealizedPnL")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("FinSim.Domain.Models.Transaction", b =>
                {
                    b.HasOne("FinSim.Domain.Models.Order", "BuyerOrder")
                        .WithMany()
                        .HasForeignKey("BuyerOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FinSim.Domain.Models.User", "Buyer")
                        .WithMany()
                    ...
                    b.HasOne("FinSim.Domain.Models.Order", "SellerOrder")
                        .WithMany()
                        .HasForeignKey("SellerOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FinSim.Domain.Models.User", "Seller")
                        .WithMany()
